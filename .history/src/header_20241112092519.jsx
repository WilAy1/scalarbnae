...
const Header = ()=>{
    ...
    return (
        ...
        <div className='w-full h-full flex items-center justify-between'>
          <div className='uppercase text-[18px] md:text-[22px] lg:text-[1.736vw] anim_text1'><span className="italic font-[300]">Gideon</span><span className='font-medium'> oladimeji</span></div>
          ...
          <div className="md:hidden block" onClick={()=>setShowMenu(true)}>
...
const Menu = ({menuController}) => {
    return (
        <div className="md:hidden fixed h-full w-full z-50 left-0 top-0 bg-[#2B50AA]">
            <div className="p-[24px] h-full flex flex-col gap-[58px]">
                <div className='bg-[#FCFCFC] w-full rounded-[20px] px-[24px] py-[23.5px] font-satoshi'>
                    <div className="flex items-center justify-between">
                        ...
                        <div className="" onClick={()=>menuController(false)}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
